      ...
      <div className="block w-full p-6 bg-transparent border border-gray-700 rounded-xl fcards ">
        <div className="flex flex-row justify-between">
          <div className="flex flex-row">
            ...
            <h5 className="mb-2 text-2xl tracking-tight text-white font-light">
              {props.title}
            </h5>
          </div>
          <div>
            <TimeButton text={props.btntext} icon={props.icon} />
          </div>
        </div>

        <p className="font-thin mt-5 text-gray-500 line-clamp-2">
          {props.subtitle}
        </p>
